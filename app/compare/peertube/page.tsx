...
const ROWS: ComparisonRow[] = [
  ...
  },
  {
    ...
    cells: [
      ...
      `One command in; vidra doctor runs ${COUNTS.doctorChecks} checks and names the failure; deploy, rollback, backup and restore are scripted.`,
    ],
  },
  {
      ...
      <Section ground="paper">
        ...
        <div className="text-body mt-5 flex max-w-[66ch] flex-col gap-4 text-onpaper-2">
          ...
          <p>
            ...
            installs it, vidra doctor runs {COUNTS.doctorChecks} checks and
            names the failure, and
